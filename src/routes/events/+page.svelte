...
<main>
    ...
    <section class="l-container l-section">
        <p>
            A calendar of gatherings where data designers and journalists meet,
            from big conferences to local meetups. Each event links to its site
            so you can dig into the program, the speakers, or the call for talks.
        </p>
    </section>
