...
<main>
    <section class="site-header l-container">
        ...
        <p class="site-header-desc">
            A curated shelf of visualizations worth studying
        </p>
    </section>

    <section class="l-container l-section">
        <p>
            Three works every week, chosen because each one teaches something
            concrete: pacing, annotation, narrative, or technique. Every entry
            links to the original piece and to the designers behind it, so the
            shelf stays small, careful, and easy to browse.
        </p>
    </section>
